...
async def async_send_message(token: str, chat_id: str, text: str):
    token = "bot" + token
...
async def async_edit_message_text(token: str, chat_id: str, message_id: str, text: str):
    token = "bot" + token
...
async def async_get_me(token: str):
    token = "bot" + token
    request_url = "/".join([api_url, token, "getMe"])
